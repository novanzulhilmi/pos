                        ...
                        <div class="card">
                            ...
                            <form role="form" action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <input type="text" name="code" class="form-control {{ $errors->has('code') ? 'is-invalid' : '' }}" id="code" maxlength="10" placeholder="Kode Produk" maxlength="10" autofocus>
                                </div>
                                <div class="form-group">
                                    <input type="text" name="name" class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" id="name" maxlength="100" placeholder="Nama Produk" maxlength="100" required>
                                </div>
                                <div class="form-group">
